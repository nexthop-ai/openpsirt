...
export interface paths {
    ...
    "/v1/products/{product}/findings": {
         ...
         *
         *     An undisclosed flaw reported from outside carries a disclosure date, counted from `received`. One with `found_here` carries none.
         *
         *     The deadline uses the windows for flaws in our own products, counted from when a severity is first given. Recorded without one, it has no deadline until it is rated.
         *
    ...
    "/v1/products/{product}/reports": {
         ...
         * @description Records a claim that arrived, or a flaw somebody here found, and returns the reference it is reached by.
         *
         ...
         *
         *     `found_here` marks a flaw somebody here found. Recorded as a flaw, it carries no disclosure date, and it is never listed as waiting for an answer.
         *
         *     Requires: private-triage on the product
         */
...
export interface components {
    schemas: {
        ...
        ClaimedBody: {
            ...
            credit?: string;
            /** @description Whether somebody here found it. Unset is a report from outside, which carries a disclosure date once it is recorded as a flaw */
            found_here?: boolean;
        ...
        EvidenceBody: {
             ...
             * @enum {string}
             */
            no_deadline?: "not-rated" | "below-the-line" | "nothing-to-take" | "out-of-support";
        ...
        "Record-findingRequest": {
            ...
            ecosystem?: string;
            /** @description Whether somebody here found it. Unset is a report from outside, which carries a disclosure date */
            found_here?: boolean;
