...
| The screen shows the newest generation's rating and names the others beside it | A report commonly rates one issue under version 3 and version 4. The number beside the issue is the newest where both arrive together; one an earlier report recorded stays where it is, and the screen reads the newest from the ratings held rather than from that number |
