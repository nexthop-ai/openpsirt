...
| A duplicate of an issue not open here is refused at submission | Nothing is left to work on, so it buries the report with nobody having agreed. The refusal says to reject it instead, which takes the second person |
