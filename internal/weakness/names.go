...
// SPDX-License-Identifier: Apache-2.0 AND LicenseRef-CWE-terms-of-use

// Code generated by internal/tools/weakness. DO NOT EDIT.

package weakness

// Version is the catalog these names were read from.
const Version = "4.20"

// Published is the day that catalog was published.
const Published = "2026-04-30"

// names is every weakness the catalog assigns, by identifier.
