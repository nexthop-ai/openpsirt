...
// difference and this package is where those live. It was written out twice —
// unexported in one package and copied into another — while four predicates
// in two further packages had no escaping at all.
const LikeEscape = "#"
