...
func typesFor(e database.Engine) *columnTypes {
	...
	case database.Postgres:
		return &columnTypes{
			...
			name: "VARCHAR(" + strconv.Itoa(nameWidth) + ")", free: "TEXT", text: "TEXT", date: "DATE", timestamp: "TIMESTAMPTZ",
	...
	case database.MySQL, database.MariaDB:
		return &columnTypes{
			...
			name: "VARCHAR(" + strconv.Itoa(nameWidth) + ")", date: "DATE", timestamp: "DATETIME(6)",
