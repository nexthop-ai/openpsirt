...
type JudgedBody struct {
	...
	Mitigation    string        `json:"mitigation,omitempty" doc:"What a holder can do about it, where somebody said. Nothing here notices a control being removed, so this is the record somebody checks"`
