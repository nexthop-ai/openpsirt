...
var outsideTheTrail = map[string]string{
	...
	"agree-to-disclosure-movement": "the decision record",
	...
	"shorten-disclosure":           "the decision record",
	...
	"start-advisory":               "the decision record",
	...
	"rule-reports":                "recorded on the ruling, which names who proposed it and when",
	"approve-report-ruling":       "recorded on the ruling, which names who approved it and when",
	"withdraw-report-ruling":      "recorded on the ruling, which names who withdrew it and when",
